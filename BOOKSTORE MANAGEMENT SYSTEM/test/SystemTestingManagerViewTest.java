...
public class SystemTestingManagerViewTest implements ShowView {
    private User manager;
    private VBox sidebar;  // Make sidebar accessible

    public SystemTestingManagerViewTest(User manager) {
        initialize();
    ...
    public Scene execute(Stage primaryStage) {
        ...
        sidebar = new VBox();  // Initialize sidebar
    ...
    // Getter for sidebar to access it in the tests
