...
import com.example.bookstore.model.Manager;
...
//        User user = new User(firstName, lastName, phone, email, password, role, salary, birthday, canAddBook, canAddBill);
//
//        this.addInAllEmployees(user);
//        writeAllEmployees();
//        return true;
//    }
    ...
    public boolean isAdded(String firstName, String lastName, String phone, String email, String password, String role, double salary, Date birthday, boolean canAddBook, boolean canAddBill) {
        ...
        switch (role) {
            ...
            case "Manager":
                ...
                break;
            case "Admin":
                newUser = new Administrator(firstName, lastName, phone, email, password, role, salary, birthday);
                break;
            default:
